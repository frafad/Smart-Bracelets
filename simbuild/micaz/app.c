...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bd6458, const void *arg_0xb7bd65f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b878c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a31840), 
int (*key_eq_fn)(void *arg_0xb7a31c88, void *arg_0xb7a31e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb79009b8, int arg_0xb7900b10);
static double RandomUniform(void );
...
#line 244
    {
      ...
      if (SmartBraceletsC$phase[sim_node()] == 0 && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 0) {

          sim_log_debug(164U, "radio_rec", "Received pairing packet at time %s with key %s\n", sim_time_string(), msg->data);
          ...
          if (strncmp((uint8_t *)msg->data, SmartBraceletsC$key[sim_node()], 20) == 0) {
              ...
              sim_log_debug(165U, "radio_rec", "Same key as mote %d, will now wait for pairing confirmation message\n", SmartBraceletsC$paired_device[sim_node()]);
        ...
        if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == 1) {
            sim_log_debug(166U, "radio_rec", "Received PAIRING_CONFIRM message\n");
          }
        else {
#line 266
          if (SmartBraceletsC$phase[sim_node()] == 2 && ((__nesc_ntoh_uint8(msg->msg_type.nxdata) == 2 || __nesc_ntoh_uint8(msg->msg_type.nxdata) == 3) || __nesc_ntoh_uint8(msg->msg_type.nxdata) == 4)) {
              ...
              sim_log_debug(167U, "radio_rec", "Received INFO -- position: (%d, %d)  status: %d\n", SmartBraceletsC$last_position[sim_node()].x, SmartBraceletsC$last_position[sim_node()].y, __nesc_ntoh_uint8(msg->msg_type.nxdata));
              SmartBraceletsC$DisconnectionTimer$stop();
              SmartBraceletsC$DisconnectionTimer$startPeriodic(60000);
            }
          else {
#line 272
            if (SmartBraceletsC$phase[sim_node()] == 2 && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 5) {
                SmartBraceletsC$last_position[sim_node()].x = __nesc_ntoh_uint16(msg->pos_x.nxdata);
                SmartBraceletsC$last_position[sim_node()].y = __nesc_ntoh_uint16(msg->pos_y.nxdata);
                sim_log_debug(168U, "FALLING ALARM", "Received child is falling at position (%d, %d)\n", SmartBraceletsC$last_position[sim_node()].x, SmartBraceletsC$last_position[sim_node()].y);
                SmartBraceletsC$DisconnectionTimer$stop();
                SmartBraceletsC$DisconnectionTimer$startPeriodic(60000);
              }
            }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73840a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73840a0, addr, msg, len);
#line 80
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76a0178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76a0178, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(155U, "radio", "Radio on on node %d!\n", TOS_NODE_ID);
      SmartBraceletsC$PairingTimer$startPeriodic(500);
    }
  else 
#line 128
    {
      sim_log_error(156U, "radio", "AMControl failed to start on node %d, retrying...\n", TOS_NODE_ID);
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73866a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73866a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73866a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb785c650){
#line 75
  switch (arg_0xb785c650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb785c650);
#line 75
      break;
#line 75
    }
...
#line 147
    {
      ...
      if (SmartBraceletsC$AMSend$send(AM_BROADCAST_ADDR, &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(158U, "radio_send", "Sending PAIRING packet with key %s", msg->data);
...
#line 172
{
  ...
  sim_log_debug(160U, "MISSING ALARM", "Child bracelet missing, last known position: (%d, %d)\n", SmartBraceletsC$last_position[sim_node()].x, SmartBraceletsC$last_position[sim_node()].y);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74073a8){
#line 83
  switch (arg_0xb74073a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74073a8);
#line 83
      break;
#line 83
    }
...
#line 107
{
  ...
  if (TOS_NODE_ID < 3) {
      ...
      sim_log_debug(153U, "boot", "Assigned key %s to node %d.\n", SmartBraceletsC$key[sim_node()], TOS_NODE_ID);
    }
  else {
      strcpy(SmartBraceletsC$key[sim_node()], "sup3r_s3cret-addr3s1");
      sim_log_debug(154U, "boot", "Assigned key %s to node %d.\n", SmartBraceletsC$key[sim_node()], TOS_NODE_ID);
    }
...
#line 55
    {
      ...
      if (SmartBraceletsC$AMSend$send(SmartBraceletsC$paired_device[sim_node()], &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(148U, "radio_send", "Sending PAIRING_CONFIRM packet to mote %d", SmartBraceletsC$paired_device[sim_node()]);
          SmartBraceletsC$radio_busy[sim_node()] = TRUE;
...
#line 187
{
  ...
  if (&SmartBraceletsC$packet[sim_node()] == buf && err == SUCCESS) {
      ...
      if (SmartBraceletsC$phase[sim_node()] != 0) {
          if (SmartBraceletsC$PacketAcknowledgements$wasAcked(&SmartBraceletsC$packet[sim_node()])) {
              ...
              if (SmartBraceletsC$phase[sim_node()] == 1) {
                  ...
                  sim_log_debug(161U, "radio_send", "Pairing confirmation was acked, starting Operation Mode\n");
                  if (TOS_NODE_ID % 2 == 0) {
              ...
              if (SmartBraceletsC$phase[sim_node()] == 2) {
                }
            }
          else 

            {
              sim_log_debug(162U, "radio_send", "Packet in phase %d not acked, retrying...\n", SmartBraceletsC$phase[sim_node()]);
...
#line 228
    {
      sim_log_error(163U, "radio_send", "sendDone error!\n");
    }
}
...
#line 77
{
  ...
  if (SmartBraceletsC$radio_busy[sim_node()]) {
      ...
      if (SmartBraceletsC$AMSend$send(SmartBraceletsC$paired_device[sim_node()], &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(150U, "radio_send", "Sending INFO packet with position (%d, %d) and status %d", __nesc_ntoh_uint16(msg->pos_x.nxdata), __nesc_ntoh_uint16(msg->pos_y.nxdata), __nesc_ntoh_uint8(msg->msg_type.nxdata));
          SmartBraceletsC$radio_busy[sim_node()] = TRUE;
