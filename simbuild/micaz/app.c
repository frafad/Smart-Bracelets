...
#line 242
    {
      ...
      if (SmartBraceletsC$phase[sim_node()] == 0 && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 0) {
          ...
          sim_log_debug(165U, "radio_rec", "Received packet at time %s with key %s\n", sim_time_string(), msg->data);
          ...
          if (strncmp((uint8_t *)msg->data, SmartBraceletsC$key[sim_node()], 20) == 0) {
              ...
              sim_log_debug(166U, "radio_rec", "Same key as mote %d\n", SmartBraceletsC$paired_device[sim_node()]);
        ...
        if (SmartBraceletsC$phase[sim_node()] == 1 && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 1) {
            sim_log_debug(167U, "radio_rec", "Received PAIRING_CONFIRM message\n");
...
#line 270
            if (SmartBraceletsC$phase[sim_node()] == 2 && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 5) {
                sim_log_debug(169U, "FALLING ALARM", "Received child is falling!\n");
                SmartBraceletsC$DisconnectionTimer$stop();
                SmartBraceletsC$DisconnectionTimer$startPeriodic(60000);
              }
            }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb76dfac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb76dfac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb76dfac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73c20a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73c20a0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76df108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76df108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb76dd178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb76dd178, msg, payload, len);
#line 78
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73c36a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73c36a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73c36a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74443a8){
#line 83
  switch (arg_0xb74443a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74443a8);
#line 83
      break;
#line 83
    }
...
#line 187
{
  ...
  sim_log_debug(161U, "radio_send", "sendDone was called\n");
      ...
      if (SmartBraceletsC$phase[sim_node()] != 0) {
          if (SmartBraceletsC$PacketAcknowledgements$wasAcked(&SmartBraceletsC$packet[sim_node()])) {
              ...
              if (SmartBraceletsC$phase[sim_node()] == 1) {
                  ...
                  sim_log_debug(162U, "radio_send", "Starting Operation Mode\n");
                  if (TOS_NODE_ID % 2 == 0) {
            ...
            {
              sim_log_debug(163U, "radio_send", "Packet in phase %d not acked, retrying...\n", SmartBraceletsC$phase[sim_node()]);
...
#line 226
    {
      sim_log_error(164U, "radio_send", "sendDone error!\n");
    }
}
