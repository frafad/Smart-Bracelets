...
#line 88
# 232 "SmartBraceletsC.nc"
static inline message_t *SmartBraceletsC$Receive$receive(message_t *buf, void *payload, uint8_t len)
#line 232
{

  sim_log_debug(167U, "radio_rec", "Receive.receive was called");
...
#line 237
    {
      ...
      if (SmartBraceletsC$phase[sim_node()] == 0 && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 0) {
          ...
          sim_log_debug(168U, "radio_rec", "Mote %d received packet at time %s with key %s\n", TOS_NODE_ID, sim_time_string(), msg->data);
          ...
          if (strncmp((uint8_t *)msg->data, SmartBraceletsC$key[sim_node()], 20) == 0) {
              ...
              sim_log_debug(169U, "radio_rec", "Mote %d has the same key as mote %d", TOS_NODE_ID, SmartBraceletsC$paired_device[sim_node()]);
        ...
        if (SmartBraceletsC$phase[sim_node()] == 1 && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 1) {
            sim_log_debug(170U, "radio_rec", "Mote %d received PAIRING_CONFIRM message");
...
#line 259
          if (SmartBraceletsC$phase[sim_node()] == 2 && ((__nesc_ntoh_uint8(msg->msg_type.nxdata) == 2 || __nesc_ntoh_uint8(msg->msg_type.nxdata) == 3) || __nesc_ntoh_uint8(msg->msg_type.nxdata) == 4)) {
              ...
              sim_log_debug(171U, "radio_rec", "INFO -- position: (%d, %d)  status: %d", SmartBraceletsC$last_position[sim_node()].x, SmartBraceletsC$last_position[sim_node()].y, __nesc_ntoh_uint8(msg->msg_type.nxdata));
...
#line 265
            if (SmartBraceletsC$phase[sim_node()] == 2 && __nesc_ntoh_uint8(msg->msg_type.nxdata) == 5) {
                sim_log_debug(172U, "FALLING ALARM", "");
                SmartBraceletsC$DisconnectionTimer$stop();
                SmartBraceletsC$DisconnectionTimer$startPeriodic(60000);
              }
            }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb73b00a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb73b00a0, addr, msg, len);
#line 80
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73b16a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73b16a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73b16a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 144
    {
      ...
      if (SmartBraceletsC$AMSend$send(AM_BROADCAST_ADDR, &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(158U, "radio_send", "Mote %d sending PAIRING packet with key %s", TOS_NODE_ID, msg->data);
...
#line 166
{
  ...
  sim_log_debug(160U, "MISSING ALARM", "Child bracelet missing, last known position: (%d, %d)", SmartBraceletsC$last_position[sim_node()].x, SmartBraceletsC$last_position[sim_node()].y);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb74323a8){
#line 83
  switch (arg_0xb74323a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb74323a8);
#line 83
      break;
#line 83
    }
...
#line 54
    {
      ...
      if (SmartBraceletsC$AMSend$send(SmartBraceletsC$paired_device[sim_node()], &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(148U, "radio_send", "Mote %d sending PAIRING_CONFIRM packet to mote %d", TOS_NODE_ID, SmartBraceletsC$paired_device[sim_node()]);
          SmartBraceletsC$radio_busy[sim_node()] = TRUE;
  ...
  if (&SmartBraceletsC$packet[sim_node()] == buf && err == SUCCESS) {
      ...
      if (SmartBraceletsC$PacketAcknowledgements$wasAcked(&SmartBraceletsC$packet[sim_node()])) {
          ...
          if (SmartBraceletsC$phase[sim_node()] == 2) {
              sim_log_debug(164U, "radio_send", "INFO packet acked correctly");
            }
        }
      else 
        {

          sim_log_debug(165U, "radio_send", "Packet in phase %d not acked, retrying...", SmartBraceletsC$phase[sim_node()]);
    ...
    {
      sim_log_error(166U, "radio_send", "sendDone error!");
    }
}
...
#line 76
{
  ...
  if (SmartBraceletsC$radio_busy[sim_node()]) {
      ...
      if (SmartBraceletsC$AMSend$send(1, &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(150U, "radio_send", "Mote %d sending INFO packet with position (%d, %d) and status %d", TOS_NODE_ID, __nesc_ntoh_uint16(msg->pos_x.nxdata), __nesc_ntoh_uint16(msg->pos_y.nxdata), __nesc_ntoh_uint8(msg->msg_type.nxdata));
          SmartBraceletsC$radio_busy[sim_node()] = TRUE;
