...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7bbe458, const void *arg_0xb7bbe5f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b6f8c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7a19840), 
int (*key_eq_fn)(void *arg_0xb7a19c88, void *arg_0xb7a19e00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78e89b8, int arg_0xb78e8b10);
static double RandomUniform(void );
...
typedef sensor_read /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$val_t;
...
static void SmartBraceletsC$AMControl$startDone(error_t error);
#line 138
static void SmartBraceletsC$AMControl$stopDone(error_t error);
...
static void SmartBraceletsC$DisconnectionTimer$fired(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t SmartBraceletsC$AMControl$start(void );
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void SmartBraceletsC$DisconnectionTimer$startPeriodic(uint32_t dt);
#line 78
static void SmartBraceletsC$DisconnectionTimer$stop(void );
#line 64
...
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
static am_addr_t SmartBraceletsC$AMPacket$source(
#line 84
message_t * amsg);
# 33 "SmartBraceletsC.nc"
uint8_t SmartBraceletsC$key[1000][21];
uint8_t SmartBraceletsC$phase[1000];

position SmartBraceletsC$last_position[1000];
sensor_read SmartBraceletsC$last_data[1000];

bool SmartBraceletsC$radio_busy[1000];

am_addr_t SmartBraceletsC$paired_device[1000];
message_t SmartBraceletsC$packet[1000];

void (*SmartBraceletsC$function_to_call[1000])(void );


static void SmartBraceletsC$send_pairing_confirm(void );
static void SmartBraceletsC$send_info_to_parent(void );
...
#line 124
static inline void SmartBraceletsC$AMControl$startDone(error_t err);
...
static inline void SmartBraceletsC$AMControl$stopDone(error_t err);
...
#line 172
static inline void SmartBraceletsC$DisconnectionTimer$fired(void );
...
#line 287
static inline void SmartBraceletsC$Read$readDone(error_t result, sensor_read data);
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
inline static void SmartBraceletsC$DisconnectionTimer$stop(void ){
#line 78
...
#line 78
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
inline static am_addr_t SmartBraceletsC$AMPacket$source(message_t * amsg){
#line 88
  unsigned short __nesc_result;
#line 88
...
#line 238
    {
      ...
      if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == 0) {
          ...
          if (strncmp((uint8_t *)msg->data, SmartBraceletsC$key[sim_node()], 20) == 0) {

              SmartBraceletsC$paired_device[sim_node()] = SmartBraceletsC$AMPacket$source(buf);
              sim_log_debug(161U, "radio_rec", "[%s] PAIRING --- received matching key from mote %d\n", sim_time_string(), SmartBraceletsC$paired_device[sim_node()]);

              SmartBraceletsC$phase[sim_node()] = 1;

              SmartBraceletsC$function_to_call[sim_node()] = &SmartBraceletsC$send_pairing_confirm;
              SmartBraceletsC$send_pairing_confirm();
            }
        }
      else {
        if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == 1) {

            sim_log_debug(162U, "radio_rec", "[%s] PAIRING_CONFIRM --- received\n", sim_time_string());
            SmartBraceletsC$PairingTimer$stop();
          }
        else {
#line 261
          if (SmartBraceletsC$paired_device[sim_node()] == SmartBraceletsC$AMPacket$source(buf) && SmartBraceletsC$phase[sim_node()] == 2 && __nesc_ntoh_uint8(msg->msg_type.nxdata) != 0 && __nesc_ntoh_uint8(msg->msg_type.nxdata) != 1) {

              SmartBraceletsC$last_position[sim_node()].x = __nesc_ntoh_uint16(msg->pos_x.nxdata);
              SmartBraceletsC$last_position[sim_node()].y = __nesc_ntoh_uint16(msg->pos_y.nxdata);

              if (__nesc_ntoh_uint8(msg->msg_type.nxdata) == 5) {
                  sim_log_debug(163U, "FALLING ALARM", "[%s] FALLING ALARM --- child is falling at position (%d, %d)\n", sim_time_string(), SmartBraceletsC$last_position[sim_node()].x, SmartBraceletsC$last_position[sim_node()].y);
                }
              else 
#line 268
                {
                  sim_log_debug(164U, "radio_rec", "[%s] INFO --- received position: (%d, %d) and status: %d\n", sim_time_string(), SmartBraceletsC$last_position[sim_node()].x, SmartBraceletsC$last_position[sim_node()].y, __nesc_ntoh_uint8(msg->msg_type.nxdata));
                }

              SmartBraceletsC$DisconnectionTimer$stop();
              SmartBraceletsC$DisconnectionTimer$startPeriodic(60000);
            }
          }
        }
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb768aac8, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb768aac8) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb768aac8, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 162
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb736f0a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb736f0a0, addr, msg, len);
#line 80
...
#line 75
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb768a108, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb768a108, msg, error);
#line 110
}
#line 110
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7688178, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7688178, msg, payload, len);
#line 78
...
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t SmartBraceletsC$AMControl$start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 64
# 124 "SmartBraceletsC.nc"
static inline void SmartBraceletsC$AMControl$startDone(error_t err)
#line 124
{
  if (err == SUCCESS) {
      sim_log_debug(153U, "radio", "[%s] Radio on on node %d!\n", sim_time_string(), TOS_NODE_ID);
      SmartBraceletsC$PairingTimer$startPeriodic(500);
    }
  else 
#line 128
    {
      sim_log_error(154U, "radio", "[%s] AMControl failed to start on node %d, retrying...\n", sim_time_string(), TOS_NODE_ID);
      SmartBraceletsC$AMControl$start();
    }
}
...
#line 113
  SmartBraceletsC$AMControl$startDone(error);
#line 113
}
#line 113
# 96 "/opt/tinyos-main-2.1.2/tos/lib/tossim/TossimPacketModelC.nc"
...
# 134 "SmartBraceletsC.nc"
static inline void SmartBraceletsC$AMControl$stopDone(error_t err)
#line 134
{
  sim_log_debug(155U, "boot", "[%s] Radio stopped!\n", sim_time_string());
}
...
#line 138
  SmartBraceletsC$AMControl$stopDone(error);
#line 138
}
#line 138
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb73706a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb73706a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb73706a8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7844650){
#line 75
  switch (arg_0xb7844650) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7844650);
#line 75
      break;
#line 75
    }
...
#line 141
{
  ...
  if (SmartBraceletsC$radio_busy[sim_node()]) {
      return;
    }
  else 
#line 147
    {
      ...
      my_msg_t *msg = (my_msg_t *)SmartBraceletsC$Packet$getPayload(&SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t ));
      ...
      strncpy(msg->data, SmartBraceletsC$key[sim_node()], 20);

      if (SmartBraceletsC$AMSend$send(AM_BROADCAST_ADDR, &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(156U, "radio_send", "[%s] PAIRING --- sending broadcast with key %s\n", sim_time_string(), msg->data);
          SmartBraceletsC$radio_busy[sim_node()] = TRUE;
        }
    }
...
#line 172
{
  ...
  sim_log_debug(157U, "MISSING ALARM", "[%s] MISSING ALARM --- child bracelet missing, last known position: (%d, %d)\n", sim_time_string(), SmartBraceletsC$last_position[sim_node()].x, SmartBraceletsC$last_position[sim_node()].y);
}
...
#line 287
{
  ...
  SmartBraceletsC$last_data[sim_node()] = data;
  SmartBraceletsC$function_to_call[sim_node()] = &SmartBraceletsC$send_info_to_parent;
  SmartBraceletsC$send_info_to_parent();
}
...
#line 19
{
  ...
  result.x = /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
  result.y = /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();

  p = /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Random$rand16();
  p = p % 10;
...
#line 40
  /*SmartBraceletsAppC.FakeSensorC.FakeSensorP*/FakeSensorP$0$Read$readDone(SUCCESS, result);
}
...
#line 83
    case 2U:
#line 83
      SmartBraceletsC$DisconnectionTimer$fired();
#line 83
      break;
#line 83
    case 3U:
...
#line 62
# 107 "SmartBraceletsC.nc"
static inline void SmartBraceletsC$Boot$booted(void )
#line 107
{
  sim_log_debug(150U, "boot", "[%s] Application booted.\n", sim_time_string());

  if (TOS_NODE_ID < 3) {
      strcpy(SmartBraceletsC$key[sim_node()], "sup3r_s3cret-addr3s0");
      sim_log_debug(151U, "boot", "[%s] Assigned key %s to node %d.\n", sim_time_string(), SmartBraceletsC$key[sim_node()], TOS_NODE_ID);
    }
  else {
      strcpy(SmartBraceletsC$key[sim_node()], "sup3r_s3cret-addr3s1");
      sim_log_debug(152U, "boot", "[%s] Assigned key %s to node %d.\n", sim_time_string(), SmartBraceletsC$key[sim_node()], TOS_NODE_ID);
    }
...
#line 55
    {
      ...
      if (SmartBraceletsC$AMSend$send(SmartBraceletsC$paired_device[sim_node()], &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(148U, "radio_send", "[%s] PAIRING_CONFIRM --- sent confirmation to mote %d\n", sim_time_string(), SmartBraceletsC$paired_device[sim_node()]);
          SmartBraceletsC$radio_busy[sim_node()] = TRUE;
        }
    }
}
...
#line 187
{
  ...
  if (&SmartBraceletsC$packet[sim_node()] == buf && err == SUCCESS) {
      ...
      SmartBraceletsC$radio_busy[sim_node()] = FALSE;

      if (__nesc_ntoh_uint8(msg->msg_type.nxdata) != 0) {

          if (SmartBraceletsC$PacketAcknowledgements$wasAcked(&SmartBraceletsC$packet[sim_node()])) {

              if (SmartBraceletsC$phase[sim_node()] == 1) {


                  sim_log_debug(158U, "radio_send", "[%s] PAIRING_CONFIRM --- confirmation was acked, starting Operation Mode\n", sim_time_string());
                  if (TOS_NODE_ID % 2 == 0) {
                  ...
                  SmartBraceletsC$phase[sim_node()] = 2;
                }
            }
          else 

            {
              sim_log_debug(159U, "radio_send", "[%s] Packet in phase %d not acked, retrying...\n", sim_time_string(), SmartBraceletsC$phase[sim_node()]);
              (*SmartBraceletsC$function_to_call[sim_node()])();
            }
        }
    }
  else 
#line 222
    {
      sim_log_error(160U, "radio_send", "[%s] sendDone error on mote %d!\n", sim_time_string(), TOS_NODE_ID);
    }
}
...
#line 77
{
  ...
  if (SmartBraceletsC$radio_busy[sim_node()]) {
      ...
      __nesc_hton_uint8(msg->msg_type.nxdata, SmartBraceletsC$last_data[sim_node()].status);
      __nesc_hton_uint16(msg->pos_x.nxdata, SmartBraceletsC$last_data[sim_node()].x);
      __nesc_hton_uint16(msg->pos_y.nxdata, SmartBraceletsC$last_data[sim_node()].y);
      strncpy((uint8_t *)msg->data, SmartBraceletsC$key[sim_node()], 20);

      SmartBraceletsC$PacketAcknowledgements$requestAck(&SmartBraceletsC$packet[sim_node()]);

      if (SmartBraceletsC$AMSend$send(SmartBraceletsC$paired_device[sim_node()], &SmartBraceletsC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(149U, "radio_send", "[%s] INFO --- sent position (%d, %d) and status %d\n", sim_time_string(), __nesc_ntoh_uint16(msg->pos_x.nxdata), __nesc_ntoh_uint16(msg->pos_y.nxdata), __nesc_ntoh_uint8(msg->msg_type.nxdata));
          SmartBraceletsC$radio_busy[sim_node()] = TRUE;
        }
    }
}
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "SmartBraceletsC$phase"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$phase[__nesc_mote];
    *size = sizeof(SmartBraceletsC$phase[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletsC$last_position"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$last_position[__nesc_mote];
    *size = sizeof(SmartBraceletsC$last_position[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletsC$last_data"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$last_data[__nesc_mote];
    *size = sizeof(SmartBraceletsC$last_data[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletsC$radio_busy"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$radio_busy[__nesc_mote];
    *size = sizeof(SmartBraceletsC$radio_busy[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "SmartBraceletsC$paired_device"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$paired_device[__nesc_mote];
    *size = sizeof(SmartBraceletsC$paired_device[__nesc_mote]);
    return 0;
  }
  ...
  if (!strcmp(varname, "SmartBraceletsC$function_to_call"))
  {
    *addr = (uintptr_t)&SmartBraceletsC$function_to_call[__nesc_mote];
    *size = sizeof(SmartBraceletsC$function_to_call[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  SmartBraceletsC$phase[__nesc_mote] = 0;
  memset((void *)&SmartBraceletsC$last_position[__nesc_mote], 0, sizeof SmartBraceletsC$last_position[__nesc_mote]);
  memset((void *)&SmartBraceletsC$last_data[__nesc_mote], 0, sizeof SmartBraceletsC$last_data[__nesc_mote]);
  SmartBraceletsC$radio_busy[__nesc_mote] = FALSE;
  memset((void *)&SmartBraceletsC$paired_device[__nesc_mote], 0, sizeof SmartBraceletsC$paired_device[__nesc_mote]);
  memset((void *)&SmartBraceletsC$packet[__nesc_mote], 0, sizeof SmartBraceletsC$packet[__nesc_mote]);
  memset((void *)&SmartBraceletsC$function_to_call[__nesc_mote], 0, sizeof SmartBraceletsC$function_to_call[__nesc_mote]);
